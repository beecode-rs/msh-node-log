...
describe('logger - ConsoleLogger', () => {
    ...
    describe('constructor', () => {
        ...
        [
            ['error', _1.LogLevelType.ERROR],
            ['warn', _1.LogLevelType.WARN],
            ['info', _1.LogLevelType.INFO],
            ['debug', _1.LogLevelType.DEBUG],
            ['ERROR', _1.LogLevelType.ERROR],
            ['WARN', _1.LogLevelType.WARN],
            ['INFO', _1.LogLevelType.INFO],
            ['DEBUG', _1.LogLevelType.DEBUG],
            ...
            it(`should allow string values [${testLogLevel}]`, () => {
                const infoLogger = new _1.ConsoleLogger(testLogLevel);
